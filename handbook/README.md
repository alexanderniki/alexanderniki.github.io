...
Цель этого проекта - дать вам краткую информацию, похожую на словарь терминов. Обозначить используемые при проектировании категории, поятия и термины и показать взаимосвязи между ними.
Так, чтобы у вас была "отправная точка" для дальнейших исследований.
