...
### Промылшенный дизайн и техническая эстетика
...
- [Component Driven User Interfaces](ui-design-component-driven.md) - Практика проектирования и разработки пользовательских интерфейсов с использованием повторяющихся компонентов
